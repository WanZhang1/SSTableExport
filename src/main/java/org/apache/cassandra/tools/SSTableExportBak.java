...
public class SSTableExportBak
{
    ...
    {
        String usage = String.format("Usage: %s <sstable> [-k key [-k key [...]] -x key [-x key [...]]] %n", SSTableExportBak.class.getName());
        //String arg[]={"/var/lib/cassandra/data/keyspace1/users/keyspace1-users-he-1-Data.db"};
        //String arg[]={"/Users/zhangwan/embrace/sale_record/user_train-sale_record-he-688-Data.db"};
