...
public class SSTableExport2 {
    ...
    static void export(SSTableReader reader, FSDataOutputStream outs, String[] excludes) throws IOException
    {
     ...
     */
    public static void export(Descriptor desc, FSDataOutputStream outs, String[] excludes) throws IOException {
    ...
    public static void main(String[] args) throws IOException, ConfigurationException {
        String usage = String.format("Usage: %s sstable_dir hdfs_dir ,eg:" +
                ...
                "%n", SSTableExport2.class.getName());
        ...
        DatabaseDescriptor.loadSchemas();// º”‘ÿschema
    ...
    private static FSDataOutputStream getOutputStream(String toUri) throws IOException {
